...
from users.common.mixins import CacheMixin
    ...
    def form_valid(self, form):
        ...
        if user:
            ...
            if session_key:
                ...
                messages.success(self.request, f"{user.username}, Ви ввійшли в аккаунт")
...
class UserRegistrationView(CreateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, f"{user.username}, Ви успішно зареєстровані і ввійшли  в аккаунт")
...
#             messages.success(request, f"{user.username}, Ви успішно зареєстровані і ввійшли в акаунт")
#             return HttpResponseRedirect(reverse('main:index'))
#     else:
